...
(function (global) {
  ...
  var FR = {
    ...
    /* ---- home: pricing section + one-page bits ---- */
    'hs.qr.cta': 'Voir comment ça marche',
    'faq.all': 'Voir toutes les questions',
    'pp.eyebrow': 'Tarifs',
    'pp.h2': 'Commencez gratuitement. <em>Évoluez quand vous voulez.</em>',
    'pp.sub': "Concevez votre médaille gratuitement pendant une heure, achetez-la une fois quand elle vous plaît, et ajoutez Premium seulement si vous voulez les cinq fonctions avancées. Même principe dans chaque formule — le prix est annoncé au lancement.",
    'pp.tba': 'Annoncé au lancement',
    'pp.free.kicker': "Essayez avant d’acheter",
    'pp.free.h': 'Aperçu gratuit',
    'pp.free.amt': 'Gratuit',
    'pp.free.per': 'pendant 1 heure',
    'pp.free.note': 'sans carte bancaire',
    'pp.free.l1': 'Concevez la médaille de votre animal dans le créateur',
    'pp.free.l2': 'Voyez la page de retrouvailles telle qu’elle apparaîtra',
    'pp.free.l3': 'Un QR de démonstration filigrané pour l’essayer',
    'pp.free.l4': 'Passez à une vraie médaille scannable quand vous voulez',
    'pp.free.cta': 'Démarrer l’aperçu gratuit',
    'pp.free.foot': 'sans engagement',
    'pp.tag.kicker': 'Achat unique',
    'pp.tag.h': 'Médaille PetFind',
    'pp.tag.per': 'payé une fois',
    'pp.tag.note': 'la médaille fonctionne pour toujours',
    'pp.tag.l1': 'La médaille QR en forme de patte, livrée chez vous',
    'pp.tag.l2': 'Page de retrouvailles toujours active — vous appeler, vétérinaire le plus proche, vos étapes',
    'pp.tag.l3': 'Configuration chez vous — sans abonnement',
    'pp.tag.l4': 'Modifiable à tout moment depuis votre compte',
    'pp.tag.cta': 'Obtenir la médaille',
    'pp.tag.foot': 'elle est à vous',
    'pp.best.badge': 'Meilleur choix',
    'pp.best.kicker': 'Médaille + abonnement mensuel',
    'pp.best.h': 'Médaille + Premium',
    'pp.best.per': 'par mois',
    'pp.best.note': 'résiliable à tout moment',
    'pp.best.l0': 'Tout de la médaille, plus :',
    'pp.best.l1': 'Localisation en direct & alertes de zone sûre',
    'pp.best.l2': 'Constantes de santé & alertes de tendance',
    'pp.best.l3': 'Dossier médical & calendrier des médicaments',
    'pp.best.l4': 'Rendez-vous vétérinaires & escalade d’urgence',
    'pp.best.l5': 'Gamelles & distributeurs connectés',
    'pp.best.cta': 'Obtenir médaille + Premium',
    'pp.best.foot': 'tout le système connecté',
    'pp.foot': "La médaille fonctionne toujours sans abonnement. Premium est optionnel — ajoutez-le ou résiliez-le quand vous voulez.",
    ...
    'co.plan.subprice': 'Unique + mensuel',
