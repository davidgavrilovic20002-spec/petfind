...
(function (global) {
  ...
  var FR = {
    ...
    'acc.research.title': "Aider à prévenir les futures maladies animales",
    'acc.research.desc': "Avec votre accord, PetFind collecte les données médicales de vos animaux au fur et à mesure qu'elles sont saisies et les analyse par intelligence artificielle afin de repérer des schémas de maladie et d'aider à prévenir les maladies à l'avenir. Ce qui est collecté ne porte aucun nom : l'espèce, la race, le sexe, l'âge en mois et les entrées cliniques — vaccinations, diagnostics et traitements — jamais votre nom, celui de votre animal, son numéro de puce ni les dates exactes. Les entrées d'un même animal sont regroupées sous une référence aléatoire afin de pouvoir être étudiées ensemble, ce qui signifie que tant que le dossier de votre animal existe, nous pouvons encore retrouver et supprimer ces données pour vous. Désactivez cette option à tout moment et tout ce qui a été collecté est supprimé. Une fois que vous supprimez un animal ou votre compte, le lien est détruit définitivement et ce qui subsiste ne peut être rattaché à personne.",
    'acc.research.label': "Oui, je contribue les données anonymisées de mes animaux à la recherche par IA sur les maladies animales",
    'acc.vet.title': 'Ceci est un compte vétérinaire',
    'acc.vet.desc': "Vous êtes connecté avec un identifiant de clinique : il n'y a pas d'espace propriétaire ici. Les comptes vétérinaires ne peuvent pas posséder d'animaux et rien sur cette page ne les concerne.",
    'acc.vet.cta': "Ouvrir l'espace vétérinaire",
    'acc.claim.title': 'Récupérer un dossier vétérinaire',
    'acc.claim.desc': "Un vétérinaire a soigné votre animal avant votre inscription ? Saisissez le code qu'il vous a remis : l'animal, avec tout ce qui a déjà été consigné, rejoint votre compte.",
    'acc.claim.label': 'Code de récupération',
    'acc.claim.ph': 'PF-XXXX-XXXX',
    'acc.claim.button': 'Récupérer cet animal',
    'acc.claim.ok': 'Dossier récupéré. Votre animal apparaît ci-dessus.',
    'acc.claim.bad': 'Code inconnu ou déjà utilisé. Vérifiez auprès de votre vétérinaire.',
    'acc.delete.title': 'Supprimer le compte',
    'acc.delete.desc': 'Supprimez définitivement votre compte, vos animaux et vos médailles. Cette action est irréversible.',
    'acc.delete.button': 'Supprimer mon compte',
    ...
    'acc.2fa.title': 'Authentification à deux facteurs',
    'acc.2fa.desc': "Ajoutez une deuxième étape à la connexion avec une application d'authentification (Google Authenticator, Authy, 1Password…). Même si votre mot de passe fuite, personne ne peut se connecter sans votre téléphone.",
    'acc.2fa.enable': 'Activer la double authentification',
    'acc.2fa.disable': 'Désactiver',
    'acc.2fa.scan': "Scannez ce QR code avec votre application d'authentification, puis saisissez le code à 6 chiffres qu'elle affiche pour confirmer.",
    'acc.2fa.code': 'Code à 6 chiffres',
    'acc.2fa.confirm': 'Confirmer',
    'acc.2fa.cancel2': 'Annuler',
    'acc.2fa.eyebrow': 'Vérification de sécurité',
    'acc.2fa.challenge.title': 'Saisissez votre code de vérification',
    'acc.2fa.challenge.sub': "Ouvrez votre application d'authentification et saisissez le code à 6 chiffres.",
    'acc.2fa.verify': 'Vérifier',
    'acc.2fa.cancel': 'Annuler et se déconnecter',
    ...
    'cr.owner.p': "Votre adresse n'est jamais affichée. Seuls les numéros que vous ajoutez et le vétérinaire le plus proche apparaissent.",
    'cr.owner.name': 'Votre nom',
    'cr.owner.phone': 'Numéro de téléphone',
    'cr.owner.addphone': '+ Ajouter un autre numéro',
    'cr.owner.phones.hint': "Ajoutez votre conjoint(e), le fixe de la maison ou un voisin — la personne qui trouve voit tous les numéros et peut appeler ou écrire à chacun.",
    ...
    'ft.badge': 'Une médaille aujourd’hui · tout un système de soin ensuite',
    'ft.h1': 'Tout ce que fait PetFind, <em>expliqué</em>.',
    'ft.lede': "Tout commence par une médaille en forme de patte qui fonctionne toujours — sans pile, sans appli. Avec un abonnement, elle se transforme en cinq fonctions de plus qui veillent sur toute la vie de votre animal.",
    'ft.legend.inc': 'Inclus avec votre médaille (achat unique)',
    'ft.legend.prem': 'Premium (abonnement mensuel)',
    'ft.tier.inc': 'Inclus',
    'ft.tier.prem': 'Premium',
    'ft.f1.h': 'Médaille QR toujours active',
    'ft.f1.lead': "La médaille porte un QR code unique qui ne nécessite ni pile, ni appli, ni compte pour la personne qui trouve. Quiconque trouve votre animal le scanne et vous joint aussitôt — votre adresse n’est jamais affichée.",
    'ft.f1.s1.t': 'Un scan',
    'ft.f1.s1.d': "L’appareil photo ouvre la page de votre animal — partout, en français ou en anglais.",
    'ft.f1.s2.t': 'Vous joindre en un geste',
    'ft.f1.s2.d': "La personne vous appelle ou vous écrit directement, et lit les étapes que vous avez rédigées.",
    'ft.f1.s3.t': 'Vétérinaire le plus proche',
    'ft.f1.s3.d': "La page indique la clinique la plus proche de l’endroit où l’animal est retrouvé.",
    'ft.f2.h': 'Localisation en direct & zones sûres',
    'ft.f2.lead': "Associez un traceur PetFind ou partenaire et suivez votre animal sur une carte en direct. Dessinez des zones sûres — maison, jardin, parc — et recevez une alerte dès qu’il en sort.",
    'ft.f2.s1.t': 'Sur une carte',
    'ft.f2.s1.d': "Position en temps réel et historique, dans votre compte.",
    'ft.f2.s2.t': 'Des zones sûres',
    'ft.f2.s2.d': "Définissez les zones où votre animal peut normalement se déplacer.",
    'ft.f2.s3.t': 'Alertes de sortie',
    'ft.f2.s3.d': "Une notification part dès qu’il franchit la limite d’une zone.",
    'ft.f2.note': 'Nécessite un traceur compatible — déployé avec nos partenaires matériels.',
    'ft.f3.h': 'Constantes de santé & tendances',
    'ft.f3.lead': "Suivez poids, activité, fréquence cardiaque et respiratoire dans le temps — comme un bracelet d’activité pour votre animal. PetFind repère tôt les tendances inhabituelles et vous les signale.",
    'ft.f3.s1.t': 'Saisie ou automatique',
    'ft.f3.s1.d': "Entrez les mesures vous-même, ou laissez un appareil connecté les remplir.",
    'ft.f3.s2.t': 'Voir la tendance',
    'ft.f3.s2.d': "Des graphiques clairs montrent ce qui est normal et ce qui change.",
    'ft.f3.s3.t': 'Alertes précoces',
    'ft.f3.s3.d': "Soyez prévenu quand une mesure sort de la plage habituelle.",
    'ft.f4.h': 'Dossier médical & médicaments',
    'ft.f4.lead': "Un passeport vaccinal numérique et tout l’historique au même endroit. Quand votre vétérinaire ajoute une ordonnance, PetFind en fait un calendrier de prises avec rappels — et suit les doses administrées.",
    'ft.f4.s1.t': 'Passeport vaccinal',
    'ft.f4.s1.d': "Vaccins, diagnostics et documents réunis et partageables.",
    'ft.f4.s2.t': 'Calendrier des prises',
    'ft.f4.s2.d': "Des rappels pour chaque dose, créés automatiquement depuis l’ordonnance.",
    'ft.f4.s3.t': 'Suivi de l’observance',
    'ft.f4.s3.d': "Cochez les doses pour que vous et le vétérinaire suiviez le traitement.",
    'ft.f5.h': 'Rendez-vous vétérinaires & escalade',
    'ft.f5.lead': "Prenez rendez-vous avec des cliniques partenaires depuis l’appli. En urgence, PetFind propose le vétérinaire disponible le plus proche — mais rien n’est déclenché sans votre confirmation explicite.",
    'ft.f5.s1.t': 'Réservez en un geste',
    'ft.f5.s1.d': "Consultation, suivi ou visite à domicile auprès des cliniques proches.",
    'ft.f5.s2.t': 'Aide en urgence',
    'ft.f5.s2.d': "La clinique ouverte la plus proche est proposée rapidement.",
    'ft.f5.s3.t': 'Vous gardez la main',
    'ft.f5.s3.d': "L’escalade est toujours confirmée par le propriétaire — jamais automatique.",
    'ft.f6.h': 'Gamelles & distributeurs connectés',
    'ft.f6.lead': "Connectez un distributeur ou une fontaine compatible et gérez les repas depuis PetFind : planifiez, nourrissez à distance et voyez combien votre animal mange et boit chaque jour.",
    'ft.f6.s1.t': 'Planifiez les repas',
    'ft.f6.s1.d': "Réglez portions et horaires ; le distributeur s’occupe du reste.",
    'ft.f6.s2.t': 'Nourrir à distance',
    'ft.f6.s2.d': "Déclenchez un repas ou complétez l’eau depuis votre téléphone.",
    'ft.f6.s3.t': 'Suivi des quantités',
    'ft.f6.s3.d': "Les repas et la boisson alimentent le suivi de santé.",
    'ft.f6.note': 'Compatible avec des distributeurs partenaires — via leurs applis.',
    'ft.cta.h': 'Commencez par la médaille. Ajoutez le reste ensuite.',
    'ft.cta.p': "La médaille QR est un achat unique et fonctionne pour toujours. Ajoutez Premium quand vous voulez les cinq fonctions avancées — et résiliez à tout moment.",
    'ft.cta.b1': 'Voir les tarifs',
    'ft.cta.b2': 'Essayer le créateur',

    /* ---- pricing page ---- */
    'meta.title.pricing': 'Tarifs PetFind — comment ça marche',
    'meta.desc.pricing': "Comment fonctionnent les tarifs PetFind : un achat unique pour la médaille QR et sa fonction de retrouvailles, plus un abonnement mensuel facultatif qui débloque les cinq fonctions avancées. Résiliable à tout moment.",
    'pr.badge': 'Achetez la médaille une fois · abonnez-vous seulement si vous voulez plus',
    'pr.h1': 'Des tarifs simples, <em>sans surprise</em>.',
    'pr.lede': "Vous achetez la médaille PetFind une fois et sa fonction de retrouvailles fonctionne pour toujours. Les cinq fonctions avancées sont un abonnement mensuel facultatif, à ajouter ou résilier quand vous voulez.",
    'pr.tag.kicker': 'Achat unique',
    'pr.tag.h': 'Médaille PetFind',
    'pr.tba': 'Prix annoncé au lancement',
    'pr.tag.once': 'payé une fois',
    'pr.tag.l1': 'La médaille QR en forme de patte, livrée chez vous',
    'pr.tag.l2': 'La page QR / retrouvailles toujours active — appel du propriétaire, vétérinaire le plus proche, vos propres étapes',
    'pr.tag.l3': 'Configuration chez vous — sans abonnement',
    'pr.tag.l4': 'Modifiable à tout moment depuis votre compte ; le QR imprimé continue de fonctionner',
    'pr.tag.cta': 'Obtenir la médaille',
    'pr.sub.kicker': 'Médaille unique + abonnement mensuel',
    'pr.sub.h': 'Médaille + Premium',
    'pr.sub.mo': 'par mois',
    'pr.sub.l0': 'Tout du plan Médaille, plus :',
    'pr.sub.l1': 'Localisation en direct & alertes de zone sûre',
    'pr.sub.l2': 'Constantes de santé & alertes de tendance',
    'pr.sub.l3': 'Dossier médical & calendrier des médicaments',
    'pr.sub.l4': 'Rendez-vous vétérinaires & escalade d’urgence',
    'pr.sub.l5': 'Gamelles & distributeurs connectés',
    'pr.sub.cta': 'Obtenir médaille + Premium',
    'pr.sub.cancel': 'Résiliable à tout moment — la médaille continue de fonctionner sans abonnement.',
    'pr.try.eyebrow': 'Essayez avant d’acheter',
    'pr.try.h': 'Concevez d’abord votre médaille, gratuitement pendant une heure',
    'pr.try.p': "Créez un compte gratuit et bénéficiez d’un aperçu d’1 heure : concevez votre médaille et voyez exactement le rendu de la page. Quand vous êtes satisfait, obtenez la médaille pour activer un vrai QR scannable.",
    'pr.try.s1.t': 'Inscription & aperçu',
    'pr.try.s1.d': 'Essai gratuit d’1 h pour concevoir votre médaille et voir la page.',
    'pr.try.s2.t': 'Commandez votre médaille',
    'pr.try.s2.d': 'Entrez votre adresse ; nous expédions la médaille avec un code unique.',
    'pr.try.s3.t': 'Activez chez vous',
    'pr.try.s3.d': 'Scannez le lien imprimé, connectez-vous, configurez votre animal. Vous seul pouvez la modifier.',
    'pr.cta.h': 'Prêt quand vous l’êtes.',
    'pr.cta.p': 'Commencez par un aperçu gratuit, puis obtenez votre médaille quand vous voulez.',
    'pr.cta.btn': 'Démarrer mon aperçu gratuit',

    /* ---- pricing page: four payment options ---- */
    'pr4.eyebrow': 'Comment payer',
    'pr4.h': 'Le même PetFind — choisissez la formule qui vous convient.',
    'pr4.sub': "Commencez gratuitement, puis choisissez mensuel, tous les 3 mois ou annuel. Chaque formule payante inclut tout le système PetFind — seule la facturation change. Les prix sont annoncés au lancement.",
    'pr4.free.k': 'Pour commencer',
    'pr4.free.h': 'Gratuit',
    'pr4.free.price': 'Gratuit',
    'pr4.free.per': 'pour essayer',
    'pr4.free.l1': 'Concevez la médaille et la page de votre animal',
    'pr4.free.l2': 'Voyez la page de retrouvailles telle qu’elle apparaîtra',
    'pr4.free.l3': 'Un QR de démonstration pour l’essayer',
    'pr4.free.l4': 'Sans carte bancaire',
    'pr4.free.cta': 'Commencer gratuitement',
    'pr4.m.k': 'Mensuel',
    'pr4.m.h': '1 mois',
    'pr4.m.per': 'par mois',
    'pr4.m.l1': 'La médaille PetFind + la page de retrouvailles',
    'pr4.m.l2': 'Les cinq fonctions premium',
    'pr4.m.l3': 'Facturé chaque mois',
    'pr4.m.l4': 'Résiliable à tout moment',
    'pr4.m.cta': 'Choisir le mensuel',
    'pr4.q.k': 'Tous les 3 mois',
    'pr4.q.h': '3 mois',
    'pr4.q.per': 'par trimestre',
    'pr4.q.l1': 'Tout de la formule mensuelle',
    'pr4.q.l2': 'Facturé tous les 3 mois',
    'pr4.q.l3': 'Un meilleur tarif que le mensuel',
    'pr4.q.l4': 'Résiliable à tout moment',
    'pr4.q.cta': 'Choisir 3 mois',
    'pr4.y.badge': 'Meilleur choix',
    'pr4.y.k': 'Annuel',
    'pr4.y.h': 'Annuel',
    'pr4.y.per': 'par an',
    'pr4.y.l1': 'Tout de la formule mensuelle',
    'pr4.y.l2': 'Facturé une fois par an',
    'pr4.y.l3': 'Le meilleur prix de toutes les formules',
    'pr4.y.l4': 'Prix bloqué pendant 12 mois',
    'pr4.y.cta': 'Choisir l’annuel',

    /* ---- checkout page ---- */
    'meta.title.checkout': 'Obtenez votre médaille PetFind',
    'meta.desc.checkout': "Commandez votre médaille PetFind et entrez votre adresse de livraison. Configurez-la vous-même chez vous grâce au code unique imprimé dessus.",
    'co.eyebrow': 'Obtenez votre médaille',
    'co.h1': 'Commandez votre médaille PetFind',
    'co.intro': "Choisissez votre formule et l’adresse de livraison. Votre médaille arrive avec un code unique — vous la configurez vous-même chez vous, et seul votre compte peut la modifier ensuite.",
    'co.login.h': 'Connectez-vous pour commander',
    'co.login.p': 'Votre commande et votre adresse sont enregistrées dans votre compte PetFind.',
    'co.login.btn': 'Se connecter ou créer un compte',
    'co.demo': 'Paiement de démonstration — aucune carte n’est débitée pour l’instant',
    'co.plan.h': 'Choisissez votre formule',
    'co.plan.p': 'Les prix sont annoncés au lancement.',
    'co.plan.tag.h': 'Médaille PetFind',
    'co.plan.oneoff': 'Achat unique',
    'co.plan.tag.f1': 'La médaille QR en forme de patte, livrée chez vous',
    'co.plan.tag.f2': 'La fonction QR / page de retrouvailles toujours active',
    'co.plan.tag.f3': 'Configuration chez vous — sans abonnement',
    'co.plan.sub.h': 'Médaille + Premium',
    'co.plan.subprice': 'Unique + abonnement',
    'co.period.label': 'Choisissez votre formule d’abonnement',
    'co.period.m': '1 mois',
    'co.period.q': '3 mois',
    'co.period.y': '1 an — meilleur choix',
    'co.period.note': 'Chaque formule inclut les mêmes fonctions Premium — seule la périodicité de facturation change. Les prix sont annoncés au lancement.',
    'co.plan.sub.f1': 'Tout de la formule Médaille',
    'co.plan.sub.f2': 'Plus les 5 fonctions premium : localisation en direct, constantes de santé, dossier & médicaments, rendez-vous vétérinaires, gamelles connectées',
    'co.plan.sub.f3': 'Résiliable à tout moment',
    'co.ship.h': 'Adresse de livraison',
    'co.ship.name': 'Nom complet',
    'co.ship.addr1': 'Adresse',
    'co.ship.addr2': 'Complément d’adresse (facultatif)',
    'co.ship.city': 'Ville',
    'co.ship.zip': 'Code postal',
    'co.ship.country': 'Pays',
    'co.ship.phone': 'Téléphone',
    'co.ship.promo': 'Envoyez-moi les actualités, offres et conseils PetFind par e-mail.',
    'co.err': 'Renseignez votre nom, votre adresse, votre ville et votre code postal.',
    'co.submit': 'Passer ma commande',
    'co.legal': 'En commandant, vous acceptez nos Conditions. Aucun paiement n’est prélevé dans cette démo — votre commande est enregistrée comme « en attente ».',
    'co.sum.h': 'Récapitulatif',
    'co.sum.premium': 'Abonnement Premium',
    'co.sum.monthly': 'Mensuel',
    'co.sum.total': 'Total',
    'co.sum.tba': 'Annoncé au lancement',
    'co.sum.note': 'Vous recevrez la médaille avec un lien et un code de configuration imprimés. Scannez, connectez-vous et configurez votre animal — une minute suffit.',
    'co.ok.h': 'Commande passée 🎉',
    ...
    /* ---- setup page ---- */
    'meta.title.setup': 'Configurez votre médaille PetFind',
    'meta.desc.setup': "Activez la médaille PetFind reçue. Entrez votre code unique, connectez-vous et configurez votre animal. Seul votre compte peut la modifier ensuite.",
    'su.eyebrow': 'Activez votre médaille',
    'su.h1': 'Configurez votre médaille PetFind',
    'su.intro': "Entrez le code unique imprimé sur votre médaille (ou sur la carte fournie). Cela relie la médaille à votre compte — dès lors, vous seul pouvez la modifier, et quiconque la scanne voit simplement la page de votre animal.",
    'su.login.h': 'Connectez-vous pour activer',
    'su.login.p': 'Votre médaille est reliée à votre compte PetFind pour la gérer à tout moment.',
    'su.login.btn': 'Se connecter ou créer un compte',
    'su.uid': 'Code de la médaille',
    'su.secret': 'Code de configuration unique (mot de passe)',
