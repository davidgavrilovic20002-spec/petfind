...
(function (global) {
  ...
  var FR = {
    ...
    'acc.research.desc': "Avec votre accord, PetFind collecte les données médicales du dossier de vos animaux et les analyse par intelligence artificielle afin de repérer des schémas de maladie et d'aider à prévenir les maladies à l'avenir. Tout ce qui sert à la recherche est anonyme : nous conservons l'espèce, la race, le sexe, l'âge en mois et les entrées cliniques — vaccinations, diagnostics et traitements — et nous supprimons votre nom, celui de votre animal, son numéro de puce et les dates exactes, de sorte que rien ne relie ces données à vous. Une copie anonyme est conservée même si vous supprimez ensuite un animal ou votre compte. C'est entièrement facultatif et vous pouvez changer d'avis à tout moment.",
