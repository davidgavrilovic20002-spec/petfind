...
(function (global) {
  ...
  var FR = {
    ...
    /* ---- schedule (0032/0033) ---- */
    'cl.word.cal': '/ Agenda',
    'cl.cal.skip': "Aller à l'agenda",
    'cl.cal.back': '← Patients',
    'cl.cal.signin': 'Se connecter depuis la liste des patients',
    'cl.cal.eyebrow': 'AGENDA',
    'cl.cal.today': "Aujourd'hui",
    'cl.cal.refresh': 'Actualiser',
    'cl.cal.clinic': 'Clinique',
    'cl.cal.view': 'Vue',
    'cl.cal.date': 'Date',
    'cl.cal.v.day': 'Jour',
    'cl.cal.v.week': 'Semaine',
    'cl.cal.v.rooms': 'Salles',
    'cl.cal.v.staff': 'Praticiens',
    'cl.cal.v.surgery': 'Bloc opératoire',
    'cl.cal.empty': 'Aucun rendez-vous sur cette période.',
    'cl.cal.privacy': "Les créneaux d'un patient suivi par un confrère n'affichent que la salle, le praticien et l'horaire. L'animal et le motif ne sont pas visibles sans partage du dossier par le propriétaire.",
    'cl.nav.cal': 'Agenda',
    'cl.nav.cal.sub': 'Jour, semaine, salles, praticiens & bloc opératoire',

    /* ---- client master file (0034) ---- */
    'cli.word': '/ Clients',
    'cli.skip': 'Aller à la liste des clients',
    'cli.eyebrow': 'FICHIER CLIENT',
    'cli.title': 'Clients',
    'cli.sub': "Le fichier de la clinique sur les personnes derrière les animaux.",
    'cli.new': 'Nouveau client',
    'cli.search': 'Rechercher',
    'cli.search.ph': 'Nom',
    'cli.f.name': 'Nom *',
    'cli.f.phone': 'Téléphone',
    'cli.f.phone2': 'Autre téléphone',
    'cli.f.email': 'E-mail',
    'cli.f.address': 'Adresse',
    'cli.f.postal': 'Code postal',
    'cli.f.city': 'Ville',
    'cli.f.siret': 'SIRET (exploitation)',
    'cli.f.billing': 'Facturation',
    'cli.f.notes': 'Notes',
    'cli.b.good': 'À jour', 'cli.b.hold': 'Encours bloqué', 'cli.b.plan': 'Échéancier',
    'cli.b.vip': 'VIP', 'cli.b.debt': 'Impayé',
    'cli.save': 'Enregistrer le client',
