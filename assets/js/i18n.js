...
(function (global) {
  ...
  var FR = {
    ...
    'acc.research.title': "Aider la recherche sur les maladies animales",
    'acc.research.desc': "Si vous l'acceptez, lorsque vous supprimez un animal ou votre compte, nous conservons une copie anonyme de son dossier médical à des fins de recherche vétérinaire : espèce, race, sexe, âge en mois, ainsi que les vaccinations, diagnostics et traitements. Votre nom, celui de votre animal, son numéro de puce et les dates exactes sont supprimés, et rien ne relie cette copie à vous. C'est entièrement facultatif et vous pouvez changer d'avis à tout moment.",
    'acc.research.label': "Oui, je contribue les données anonymisées de mes animaux à la recherche",
