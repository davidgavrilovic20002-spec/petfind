...
(function () {
  ...
  var LABELS = {
    en: {
      ...
      sp: { dog: 'Dog', cat: 'Cat', rabbit: 'Rabbit', ferret: 'Ferret', bird: 'Bird',
            rodent: 'Rodent', reptile: 'Reptile', other: 'Pet' },
    ...
    fr: {
      ...
      sp: { dog: 'Chien', cat: 'Chat', rabbit: 'Lapin', ferret: 'Furet', bird: 'Oiseau',
            rodent: 'Rongeur', reptile: 'Reptile', other: 'Animal' },
